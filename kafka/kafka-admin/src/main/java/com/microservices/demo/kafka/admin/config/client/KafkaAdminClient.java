...
import com.microservices.demo.appconfigdata.RetryConfigData;
...
public class KafkaAdminClient {
    ...
    private void checkMaxRetry(int retry, Integer maxRetry) {
        if (retry > maxRetry) {
            throw new KafkaClientException("Reached max number of retery for reading kafka topic(s)!");
        }
    }
    ...
    private CreateTopicsResult doCreateTopics(RetryContext retryContext) {
        ...
        LOGGER.info("Createing {} topic(s), attempt {}", topicNames.size(), retryContext.getRetryCount());
